            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default" style="background:#EFF3F6; width:1000px;">
                    <div class="panel-body">
                        <h2>Modificar Conducta </h2>
                        <hr class="colorgraph">
                        @include('alerts.exito')
                        @include('alerts.errors')
                        <div class="form-group">
                            {!! Form::open(['route'=>'eliminarConducta.store','method'=>'POST','class'=>'navbar-form navbar-left pull-left', 'role'=>'search']) !!}
                        ...
                        <div class="container" style="padding-top: 20px">
                            <table class="table table-striped table-bordered" style="width: 800px">
                                ...
                                <td>  {!! Form::open(['route'=>['eliminarConducta.destroy'],'method'=>'DELETE']) !!}
                                    {!! Form::hidden('id', $alumno->NIE) !!}
                                  {!! Form::hidden('periodoid', $alumno->periodotrimestral_id) !!}
