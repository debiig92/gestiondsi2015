                ...
                <div class="panel panel-default" style="background:#EFF3F6; width:1000px;">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            {!! Form::open(['route'=>'conducta.store','method'=>'POST','class'=>'navbar-form navbar-left pull-left', 'role'=>'search']) !!}
                        ...
                        <div class="container" style="padding-top: 20px">
                            <table class="table table-striped table-bordered" style="width: 800px">
                                ...
                                <td><a href="{{route('registrarConducta.show',$alumno->NIE)}}">Registrar Conducta</a></td>
                                </td>
                                </tbody>
                                @endforeach
                            </table>
