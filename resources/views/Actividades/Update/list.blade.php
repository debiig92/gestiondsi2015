      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{route('updateActividad.show',$ac->id)}}" class="btn btn-primary" style="background:#23282E; border-color:#23282E;">Eliminar</a>
            </td>
          </tr>
          @endforeach
          @endif
...
{
  var route="updateActividad/"+btn.value+"/edit";
